...
export const projects = [
  ...
  },
  {
    ...
    subtitle: '전자응용설계 · 약 정보 챗봇',
    description: '증상과 사용자 조건을 입력받아 약 정보와 주변 약국 검색을 연결한 수업 프로젝트입니다. 텍스트·음성 대화와 사용자 프로필 기능을 시연했습니다.',
...
export const experience = [
  ...
  { title: '기술 프로젝트', text: 'ATmega128·STM32 임베디드 구현을 경험했습니다. MisoTalk에서는 약 정보 조사와 메인 대화 흐름, 주변 약국 검색 기능의 연결을 맡았습니다.' },
];

// 전자응용설계 발표 자료(2025년 6월)의 내용입니다. 역할은 발표 자료 9쪽을 기준으로 구분했습니다.
export const misotalk = {
  title: '사용자 상태를 반영한 약 정보 챗봇',
  context: '2025년 1학기 · 동아대학교 전자응용설계 · 2인 팀',
  overview: '증상을 텍스트나 음성으로 입력하면 대화 흐름에 따라 약 관련 정보를 안내하고, 입력한 위치를 바탕으로 주변 약국을 찾는 프로토타입입니다. 사용자 프로필과 임신 여부에 따라 응답을 분기하도록 설계했습니다.',
  role: '김민우 · 약 정보 조사 / 메인 컨트롤러 / 약국 검색 연결',
  contributions: [
    { title: '약 정보 조사', text: '증상별로 다룰 약과 가격·부작용 정보를 조사해 챗봇 응답에 필요한 자료를 정리했습니다.' },
    { title: '메인 대화 흐름', text: 'Misotalk.py 메인 컨트롤러에서 입력을 받고 증상 매칭 후 기능을 호출하는 흐름을 담당했습니다.' },
    { title: '주변 약국 검색 연결', text: '네이버 지도 크롤링 결과를 메인 파일에 연결해, 사용자가 입력한 위치에 대한 약국 목록을 보여주도록 했습니다.' },
  ],
  features: [
    { title: '텍스트·음성 입력', text: '텍스트 입력과 STT/TTS 음성 모드를 제공하고, 대화 중 입력 방식을 전환하는 흐름을 시연했습니다.' },
    { title: '사용자 프로필', text: 'SQLite에 저장한 사용자 상태를 불러와 이름과 임신 여부 등에 따라 응답을 분기했습니다.' },
    { title: '약·약국 정보', text: '증상에 따른 약 정보, 가격·부작용 질문, 입력 위치 주변 약국 목록을 한 대화에서 확인했습니다.' },
  ],
  video: '/misotalk/demo.mp4',
  videoCaption: '발표 자료에 포함된 약 1분 8초 작동 영상. 터미널에서 사용자 상태 확인, 약 정보 질문, 주변 약국 검색, 음성 모드 전환을 시연합니다.',
  limitation: '수업용 프로토타입으로, 발표 자료에는 음성 인식의 잡음 민감성, API 응답 지연, 의약품 정보의 안전성 검증 부재가 한계로 적혀 있습니다. 영상의 약·가격·부작용 답변은 실제 복약 판단에 사용하면 안 됩니다.',
};
